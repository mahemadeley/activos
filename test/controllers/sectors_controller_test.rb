...
class SectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sector" do
    assert_difference('Sector.count') do
      post sectors_url, params: { sector: { descripcion: @sector.descripcion, ubicacion: @sector.ubicacion } }
    end
  ...
  test "should update sector" do
    patch sector_url(@sector), params: { sector: { descripcion: @sector.descripcion, ubicacion: @sector.ubicacion } }
