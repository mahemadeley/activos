...
class TiposControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tipo" do
    assert_difference('Tipo.count') do
      post tipos_url, params: { tipo: { Coeficiente: @tipo.Coeficiente, bienes: @tipo.bienes, vida_util: @tipo.vida_util } }
    end
  ...
  test "should update tipo" do
    patch tipo_url(@tipo), params: { tipo: { Coeficiente: @tipo.Coeficiente, bienes: @tipo.bienes, vida_util: @tipo.vida_util } }
